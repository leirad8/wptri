<?php /* Template Name: Login Members (Clever-IDM) */ 
class CleverIDM
{
	...
	// dev
	public static $auth_url = 'https://dev.iam.telecominfraproject.com/sso/json/tip/authenticate';
	private static $validate_url = 'https://dev.iam.telecominfraproject.com/sso/json/tip/sessions/[TOKEN]?_action=validate';
	public static $profile_url = 'https://dev.iam.telecominfraproject.com:8443/openidm/IUX/profile?_action=retrieveProfile';
	...
	// prod
	/*
	private static $auth_url = 'https://prod.iam.telecominfraproject.com/sso/json/tip/authenticate';
	private static $validate_url = 'https://prod.iam.telecominfraproject.com/sso/json/tip/sessions/[TOKEN]?_action=validate';
	private static $profile_url = 'https://prod.iam.telecominfraproject.com:8443/openidm/IUX/profile?_action=retrieveProfile';
	...
	*/
	...
	public static function login($username, $password)
	{
		...
		// authorize request
		$auth_response = json_decode(self::curl(self::$auth_url, '', 'POST', $headers)); 
		...
		$auth_response = json_decode(self::curl(self::$auth_url, $data, 'POST', $headers)); 
		...
		<div class="component--page--main-content--body component--wysiwyg">
			<form method="POST" id="x_login_form" action="?x_action=login">
				...
				<div class="row">
					<div>Username:</div>
					<div>
						<input name="x_username" type="text" required="true" value="<?php echo htmlentities($_POST['x_username'],ENT_QUOTES); ?>">
					</div>
				</div>
				<div class="row">
					<div>Password:</div>
