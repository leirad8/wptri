<div id="esig-formidableform-almost-done" style="display: none;"> 
         ...
         <div > <img src="<?php echo plugins_url("formidableforms-screenshot.png",__FILE__) ; ?>" style="border: 1px solid #efefef; width: 100%;" /> </div>
        ...
        <div class="esig-updater-button">
                  ...
                  <span> <a href="?page=formidable&frm_action=settings&id=<?php echo $data['formid']; ?>&action=edit" class="button esig-dgr-btn" id="esig-formidableform-lets-go"> <?php _e('LET\'S GO NOW!','esig-nf');?> </a></span>
