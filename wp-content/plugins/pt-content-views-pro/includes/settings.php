				...
				'params'		 => array(
					array(
						...
						'params' => array(
							...
							self::field_settings_font(
								array(
									'label'		 => __( 'Pagination (inactive)', 'content-views-query-and-display-post-page' ),
									'name'		 => 'more-inactive',
									'depend'	 => array( 'enable-pagination' ),
									'font-size'	 => '',
									'color'		 => '',
							...
							!isset( $args[ 'skip_all' ] ) ? array(
								...
								'params'		 => array(
									array(
										...
										'options'	 => PT_CV_Values_Pro::text_align( __( '- Text Align -', 'content-views-pro' ) ),
										'std'		 => '',
									),
								),
								) : '',
								...
								array(
									...
									'params'		 => array(
										array(
											...
											'class'		 => 'select2',
											'multiple'	 => '1',
											'desc'		 => __( 'Select fields to exclude from the overlay', 'content-views-pro' ),
										),
									),
								),
								array(
								...
								array(
									...
									'params'		 => array(
										array(
											...
											'std'	 => '',
											'desc'	 => __( 'Set numeric positions (separate by comma, in increasing order) to show ads on each page.<br><strong>Notice:</strong> These numbers must be smaller than "Items Per Page" and "Limit" value', 'content-views-pro' ),
										),
									),
