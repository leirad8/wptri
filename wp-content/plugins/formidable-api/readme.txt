...
== Changelog ==
= 1.02 =
* Enhancement: Add headers to API call hook to allow headers to be modified
* Fix: Correct the dynamic URL check
* Fix: Load JS on Settings page load so + button works in Safari
