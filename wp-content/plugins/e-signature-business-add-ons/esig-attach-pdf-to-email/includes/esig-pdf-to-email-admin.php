...
if (!class_exists('ESIG_PDF_TO_EMAIL_Admin')) :
    ...
    class ESIG_PDF_TO_EMAIL_Admin extends esigAttachmentSetting {
        ...
        public function email_pdf_attachment() {
            ...
            WP_E_Sig()->notice->set('e-sign-green-alert resent', 'You pdf document was sent successfully to its all party involved.');
        ...
        public function document_add_data($more_contents) {
			...
			<a href="#" class="tooltip">
				...
				<input type="checkbox" ' . $checked . ' id="esig_pdf_email" data-parent="' . $parent . '" name="esig_pdf_attachment" value="1"> ' . __('Send a PDF of this agreement as an email attachment', 'esig') . '
