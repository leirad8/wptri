    ...
    class ESIG_CUSTOM_MESSAGE {
        ...
        public function document_add_data($more_contents) {
			...
			<a href="#" class="tooltip">
				...
				<input type="checkbox" ' . $checked . ' id="esig_custom_message" name="esig_custom_message" value="1"> ' . __('Add custom message to signer invite email', 'esig') . '
			...
			<a href="#" class="tooltip">
				...
				<input type="checkbox" ' . $confChecked . ' id="confirmation_custom_message" name="confirmation_custom_message" value="1"> ' . __('Add custom message to signer confirmation email', 'esig') . '
