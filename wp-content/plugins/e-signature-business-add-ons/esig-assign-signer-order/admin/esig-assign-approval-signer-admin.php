...
if (!class_exists('ESIG_ASSIGN_APPROVAL_SIGNER_Admin')) :
    ...
    class ESIG_ASSIGN_APPROVAL_SIGNER_Admin extends ESIGN_SIGNER_ORDER_SETTING {
        ...
        public function esig_assign_approval_signer_ajax() {
            ...
            //_e("Successfully saved", "esig-order");
        ...
        public function assign_approval_signer($advanced_more_options) {
            ...
            $advanced_more_options .='<p><a href="#" class="tooltip">
                                    <img src="' . ESIGN_ASSETS_DIR_URI . '/images/help.png" height="20px" width="20px" align="left"><span >' . __('Assign an approval signer to sign and approve this document once a signature is added', 'esig-order') . '</span>
                                    </a><input type="checkbox" id="esig_assign_approval_signer" name="esig_assign_approval_signer" value="1" ' . $esig_assign_approval_signer_checked . '><span style="margin-left:4px;">' . __('Assign an approval signer to sign and approve this document once a signature is added - <a href="https://www.approveme.com/wp-digital-signature-plugin-docs/article/approval-signer/" class="esig-light-link">help article</a>', 'esig-order') . '</span></p>';
