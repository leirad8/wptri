...
if (!class_exists('ESIG_ACTIVE_CAMPAIGN_Admin')) :
    ...
    class ESIG_ACTIVE_CAMPAIGN_Admin {
        ...
        private static function connect_active_campaign() {
        ...
        public function esig_active_campaign_add_meta_box() {
            ...
            if (!self::is_capaign_api_set()) {
			   ...
			   <input type="button" name="Add-submit" id="esigactivecampaign" class="button-appme button" value="Add Tag" /></p>';
                ...
                if ($tag_name == null) {
                    $content .= '<p class="tagchecklist" id="esig_active_campaign">' . __('Active campaign tag name.', 'esig-active') . '</p>';
                } else {

                    $content .= '<p class="tagchecklist remove-tag" id="esig_active_campaign"><span><a href="#" id="urlid" class="ntdelbutton">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;</a>&nbsp;' . $tag_name . '</span></p>';
                }
            }
...
function esigactivecampaign() {
    ...
    echo '<span><a href="#" id="campaignid" class="ntdelbutton campagin-tag-del">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;</a>&nbsp;' . ESIG_ACTIVE_CAMPAIGN_Admin::get_campaign_tag($document_max_id) . '</span>';
