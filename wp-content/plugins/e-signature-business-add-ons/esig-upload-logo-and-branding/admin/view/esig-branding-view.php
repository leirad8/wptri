    ...
    <div class="esig-settings-wrap">
        <table class="form-table esig-settings-form">
            ...
            <tbody>
            <h3><?php _e('Upload Custom Branding to Email Invites', 'esig-ulab'); ?></h3>
            <tr> 
            ...
            <tr>
                <th> <label for="email_sender" > <?php _e("E-mail Sender", "esig-ulab"); ?> </label></th>
                <td>
                    <?php
            ...
            <tr>
                ...
                <th><label for="email_button"><?php _e("Button Color", "esig-ulab"); ?></label></th>
                <td>
