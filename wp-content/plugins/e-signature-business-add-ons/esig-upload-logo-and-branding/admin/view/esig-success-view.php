 ...
 <!--<div style="margin: 10px;"><h3>  <?php _e('This section lets you customise the WP E-Signature Success Page','esig-ulab') ?></h3></div>-->
	...
	<tbody>
		...
		<tr>
			...
			<td><label for="">
                    ...
                    <?php _e('Do not display a success image (or icon) when a document is signed','esig-ulab') ?> </label>
