...
class ESIG_LOGO_BRANDING {
	...
	private static function single_activate() {
        ...
        {
            update_option('WP_ESignature__Upload_Logo_And_Branding_documentation','https://www.approveme.com');
        ...
        else
        {
           ...
           add_option('WP_ESignature__Upload_Logo_And_Branding_documentation','https://www.approveme.com');
        }
	}
