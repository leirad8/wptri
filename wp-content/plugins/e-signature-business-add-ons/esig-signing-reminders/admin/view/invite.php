...
<div id=":zs" class="ii gt m1436f203bed358e3 adP adO">
  <div id=":zr" style="overflow: hidden;">
    <div class="adM"> </div>
    <div
style="background-color:#efefef;margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;width:100%;max-width:600px;margin: 0 auto;">
         <!--[if mso]>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr style="border-collapse:collapse">
            <td style="font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;border-collapse:collapse"
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              bgcolor="#F7FAFC"><?php echo $data['user_full_name']; ?> <?php _e('has requested your signature', 'esig-reminders' );?></td>
                          </tr>
                        </tbody>
                      </table>
                          ...
                          <tr>
                            <td
                              ...
                              <h1 style="font-size:18px;margin:0 0 10px
                                0;font-weight:bold"><?php _e('Document Name:', 'esig-reminders' );?> <?php echo $data['document_title']; ?>
                              </h1>
                              <?php _e('Document ID:', 'esig-reminders' );?> (<?php echo $data['document_checksum']; ?>)
                              <p
                                style="line-height:1.4em;font-size:14px;margin:10px
                                0px"> <span style="color:#8c8c8c"><?php _e('From:','esig-reminders');?> <?php echo $data['user_full_name']; ?> (<a
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p
                                ...
                                <br>
                                <?php echo $data['user_full_name']; ?> <?php _e('sent you a document that needs to be signed.', 'esig-reminders' ); ?><br>
                                <br>
                                <?php _e('Please add your signature to the document below.', 'esig-reminders' );?>  - <a
href="mailto:<?php echo $data['user_email']; ?>?subject=RE%3A%20%7B<?php echo $data['document_title']; ?>%7D"
style="color:#368bc6;text-decoration:none" target="_blank"><?php _e('Got a Question?', 'esig-reminders' );?><br>
                                </a></p>
                              <hr
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              ...
                              <?php
                                      ...
                                      ?>
                               <!--[if mso]>
  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo $data['invite_url']; ?>" style="height:40px;v-text-anchor:middle;width:175px;" arcsize="10%" stroke="f" fillcolor="<?php echo $background_color ;  ?>">
    <w:anchorlock/>
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p style="margin:10px 0px;font-size:14px;line-height:1.4em;color:#ff0000">
                              	<?php _e('Warning: Do not forward this email to others or else they will have access to your document (on your behalf).', 'esig-reminders' );?></p>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                ...
                <tbody>
                  <tr style="border-collapse:collapse">
                    <td style="padding: 16px 12px 0px 20px;vertical-align: top;font-family: 'Helvetica Neue',Arial,Helvetica,sans-serif;font-size: 12px;line-height: 1.5em;border-collapse: collapse;color: #555;"
                      align="left"><?php echo sprintf( __( 'This message was sent to you by %s who is using the <a href="https://www.approveme.com/" style="text-decoration:none;color:#555;">WP E-Signature Document Signing WordPress plugin</a>. If you would rather not receive email from this sender you may contact the sender with your request.', 'esig-reminders'), $data['user_full_name'] );?> </td>
...
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
                    ...
                    <td style="padding:0px 0px 0px
                      0px;vertical-align:top;font-family:'Helvetica
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
                      align="center"> <a href="https://www.approveme.com/security-ueta-e-sign-protection/" target="_blank"><img
src="<?php echo $data['assets_dir']; ?>/images/verified-email.jpg"
                              alt="WP E-Signature" border="0" style="margin-top: -8px;"
                              height="69" width="100px;"></a><br>
                    </td>
                  </tr>
                </tbody>
              </table>
