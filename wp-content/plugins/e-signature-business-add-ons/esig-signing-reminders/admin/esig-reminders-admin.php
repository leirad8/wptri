    ...
    class ESIG_REMINDERS_Admin extends ESIG_REMINDERS_SETTINGS {
            ...
            if ($esig_footer_text == 'default') {
                $esig_footer_text = __('WP E-Signature by Approve Me is the
                                ...
                                <b>No monthly fees</b> - <b>Easy to use
                                  WordPress plugin.</b><a style="color:#368bc6;text-decoration:none" href="https://www.approveme.com/wp-digital-e-signature/?ref=1" target="_blank"> Learn more</a> ', 'esig-reminders');
            }
        ...
        public function show_more_actions($more_actions, $args) {
            ...
            if ($doc->document_status == "awaiting") {
                $more_actions .= '|<span class="esig_reminders_setting"> <a href="javascript:void(0)" data-document="' . $doc->document_id . '" data-reminder="' . $remind_text . '" data-title="' . esc_attr($doc->document_title) . '" title="Signing reminders settings " id="reminders_document">' . __('Signing Reminders', 'esig-reminders') . '</a></span> ';
            }
