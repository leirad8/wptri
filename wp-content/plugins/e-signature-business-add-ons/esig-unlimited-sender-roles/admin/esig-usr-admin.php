        ...
        public function esign_document_permission($docs) {
            ...
            foreach ($docs as $doc) {
                ...
                if ($document_id) {
                    ...
                    $esig_unlimited_users_option = json_decode($esig_settings->get_generic('esig_unlimited_users_' . $document_id), true);
...
';
        ...
        public function esign_unlimited_sender_role_view() {
            ...
            if (count($_POST) > 0) {
                ...
                if (empty($_POST['esig_roles_option']) && empty($_POST['esig_roles_user_option'])) {

                    $api->notice->set('e-sign-red-alert', __('This field are required.', 'esig'));
                } else {
                    // recieving esig roles option in array 
                    ...
                    $api->notice->set('alert e-sign-alert esig-updated', __('Well done sir', 'esig-usr') . '</strong> :  ' . __('Your E-Signature roles have been updated!', 'esig-usr'));
                }
            }
