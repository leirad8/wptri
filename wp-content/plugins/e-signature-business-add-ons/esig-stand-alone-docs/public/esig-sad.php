...
class ESIG_SAD {
    ...
    public function display_document($atts) {
        ...
        $html = '
			<p>
				<input required type="email" class="form-control" placeholder="' . __('Your email address', 'esig-sad') . '" id="esig-sad-email" name="esig-sad-email" value="' . $legal_email . '"/>
			</p>
        ';
        ...
        if (!isset($_POST['recipient_signature']) && empty($_POST['recipient_signature']) && !isset($_POST['esignature_in_text']) && empty($_POST['esignature_in_text'])) {
            ...
            if ($document_status == 'trash') {
                $template_data1 = array(
                    "message" => "<p align='center'><a href='https://www.approveme.com/wp-digital-e-signature/' title='" . __('Wordpress Digital E-Signature by Approve Me', 'esig-sad') . "' target='_blank'><img src='" . ESIGN_ASSETS_DIR_URI . "/images/logo.png' alt='Sign Documents Online using WordPress E-Signature by Approve Me'></a></p><p align='center' class='esig-404-page-template'>" . __('Well this is embarrassing, but we can\'t seem to locate the document you\'re looking to sign online.<br>You may want to send an email to the website owner. <br>Thank you for using Wordpress Digital E-Signature By', 'esig-sad') . " <a href='https://www.approveme.com/wp-digital-e-signature/' title='Free Document Signing by Approve Me'>" . __('Approve Me', 'esig-sad') . "</a></p> <p align='center'><img src='" . ESIGN_ASSETS_DIR_URI . "/images/search.svg' alt='esignature by Approve Me' class='esig-404-search'><br><a class='esig-404-btn' href='http://www.approveme.com/wp-digital-e-signature?404'>" . __('Download WP E-Signature!', 'esig-sad') . "</a></p><p>&nbsp;</p>",
                );
            ...
            $wpdb->query($wpdb->prepare(
                            "UPDATE $doc_table SET document_title = '%s' where document_id = %d", $old_doc->document_title . ' - ' . $recipient['first_name'], $doc_id));
            ...
            $event_text = __("The document has been signed by all parties and is now closed.", 'esig-sad');
            ...
            $success_msg = "<p class=\"success_title\" align=\"center\">" . sprintf(__('Excellent work! You signed {%s}.', 'esig-sad'), $doc->document_title) . "</h2> <p align='center' class='s_logo'><span class=\"icon-success-check\"></span></p>";
            ...
            $template_data = array(
                ...
                "message" => __($success_msg, 'esig-sad')
            );
