...
class ESIG_SAD_Admin {
    ...
    public function esig_sad_edit_action($edit_url, $args) {
        ...
        if ($document_type == 'stand_alone') {
            ...
            $edit_url .= "edit.php?post_type=esign&page=esign-edit-document&esig_type=sad&document_id=" . $document_id;
        }
				...
				<div class="esig_sad_popup wp-core-ui">
					...
					<form class="invite_form">
						<ul>
							...
							<li>
								<input class="esig-mini-btn esig-blue-btn" id="sad-invite-submit" type="submit" name="" value="' . __('Send Invite', 'esig-sad') . '" />
							</li>
						</ul>
...
';
    ...
    public function document_index_data($template_data) {
        ...
        if (array_key_exists('document_filters', $template_data)) {
            $template_data['document_filters'] .= "| <a title=\"View Stand Alone Documents\" href=\"$url\" $css_class >" . __('Stand Alone', 'esig-sad') . "</a> ($count)";
        }
    ...
    public function show_more_actions($more_actions, $args) {
        ...
        if ((esigget('document_type', $doc)) == "stand_alone" && (esigget('document_status', $doc)) == 'stand_alone') {
            $more_actions .= '| <a title="Edit this document" href="edit.php?post_type=esign&page=esign-edit-document&document_id=' . $doc->document_id . '">' . __('Edit', 'esig-sad') . '</a>';
        }
        if ($page_id) {
            ...
            if ($doc->document_status != "draft") {
                ...
                if ($show_invite) {
                    $more_actions .= ' | <span class="send_stand_alone_invite"><a data-url="' . $url . '" href="javascript:void(0)" data-document="' . $doc->document_id . '" data-title="' . $doc->document_title . '" title="Send invite with this document" id="sad_document_' . $doc->document_id . '">' . __('Share / Invite', 'esig-sad') . '</a></span>';
                }
            }
        }
