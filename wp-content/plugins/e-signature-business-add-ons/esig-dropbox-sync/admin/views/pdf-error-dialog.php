...
<div id="esig-pdf-error-dialog">
 ...
 $esig_user= new WP_E_User();
  $esig_settings= new WP_E_Setting();
      ...
      {
        echo $users->first_name . ",";?><?php _e(" I apologize, but we're having trouble connecting to your <em>Save as PDF add-on</em> (which is required to use this feature). <strong> For your site to magically create PDF's, you will definitely need our 'Save as PDF' add-on.","esig-ds");?></strong></p>
      <?php 
      }
      elseif(!$esig_dropbox->is_authorized())
      {
        echo $users->first_name . ",";?> <?php _e("I apologize, but we're having trouble connecting to your <em>Dropbox</em> (which is required to use this feature). <strong>  For your site to magically save PDF's, into Dropbox you need to authorize with Dropbox.","esig-ds");?></strong></p>
    <?php 
    ...
    if($esig_settings->esig_license_expired())
    {
     ...
     <p> <?php _e("To complicate the situation, It looks like your license is expired... you will need to have a valid license in order install this add-on.","esig-ds");?></p>
  
   <!-- esig updater button section -->
		<div class="esig-updater-button">
           <span> <a href="https://www.approveme.com/checkout/?edd_license_key=<?php echo $license_key ;  ?>&download_id=2660" class="button" id="esig-primary-dgr-btn"> <?php _e('Please Renew My License','esig-ds');?> </a></span>
		</div>
   ...
   <!-- esig updater button section -->
	...
	<?PHP
	 ...
	 {
	 ?>
	 	<p><?php _e("To complicate the situation, it also looks like you do not have a license key (which means your site cannot communicate with ApproveMe and receive critical updates, downloads etc)... you will need to have a valid license in order to install this add-on.","esig-ds")?>;</p>
  
   <!-- esig updater button section -->
		<div class="esig-updater-button">
           <span> <a href="https://www.approveme.com/#pricingPlans" class="button" id="esig-primary-dgr-btn"> <?php _e('Get My License Key','esig-ds');?> </a></span>
		</div>
	<?PHP
	 } // license activation check end here 
         elseif(!$esig_dropbox->is_authorized())
         ...
         <div class="esig-updater-button">
           <span> <a href="<?php echo $esig_dropbox->get_authorize_url(); ?>" class="button" id="esig-primary-dgr-btn"> <?php _e('Authorize Now','esig-ds');?> </a></span>
		</div>
	 ...
	 <div class="esig-updater-button">
           <span> <a href="admin.php?page=esign-addons" class="button" id="esig-primary-dgr-btn"> <?php _e('INSTALL IT & TURN IT ON FOR ME NOW','esig-ds');?> </a></span>
		</div>
