    ...
    class ESIG_AT_Admin extends Esig_AT_Settings{
       ...
       <div class="inside">';
        ...
        public function esig_view_action_done($args) {
            ...
            if (isset($_POST['insert_template'])  == "Insert template") {
                ...
                if ($_POST['esig_temp_document_type'] == 'sad') {
                    ...
                    wp_redirect("edit.php?post_type=esign&page=esign-edit-document&esig_type=sad&document_id=". $doc_id ."&add_tmp=1&temp_id=" . $template_id);
                    exit;
                }
            }
            if (isset($_POST['nextstep'])) {
                ...
                if ($_POST['esig_temp_document_type'] == 'basic') {
                    ...
                    wp_redirect('edit.php?post_type=esign&page=esign-edit-document&esig_type=basic&document_id=' . $doc_id . '&add_tmp=1&temp_id=' . $template_id);
                    exit;
                }
            }
        }
            ...
            elseif (has_shortcode($document_content, 'esigtempradio')) {
                ...
                for ($i = 0; $i < $noofsif; $i++) {
                    $html .= '<div id="signer_main_pop">
								...
								<input type="text" class="recipient_emails" name="recipient_emails[]" placeholder="email@address.com" value="" /><span id="second_layer_verification" class="icon-doorkey second-layer"></span><span id="esig-del-signer" class="deleteIcon"></span></div>
							 ';
                }
                // echo signer info
                echo $html;
            ...
            foreach ($this->temp_short as $temp => $value) {
                ...
                $html .= '<div id="signer_main_pop">
				 <input type="hidden" class="recipient_fnames" name="recipient_siftemp[]" value="' . $signer_id . 'ud' . $document_id . '"  />
								...
								<input type="text" class="recipient_emails" name="recipient_emails[]" placeholder="email@address.com" value="' . $user_email . '" /><span id="second_layer_verification" class="icon-doorkey second-layer"></span><span id="esig-del-signer" class="deleteIcon"></span><br>
							 ';
        ...
        public function show_template_actions($more_option_page, $args) {
            ...
            $more_option_page .= '<style>#TB_ajaxContent {max-width:460px !important;}</style><div id="template-option-step2" class="esign-form-panel" style="display:none;">
	    
				<div id="template_top">
				<div class="invitations-container" style="min-width:100%">	
            ...
            $more_option_page .='<div id="standard_view_popup_bottom" style="display:none">
				...
				<div class="invitations-container">	
					...
					<div class="af-inner" style="max-width:470px;">
						<div id="recipient_emails_temp">
							
							<div id="signer_main_temp">
								...
								'. apply_filters("esig_second_layer_verification", "") .'
                    ...
                    <span class="esig-signer-left">' . apply_filters('esig-signer-order-filter', '','') . '</span>
                    <span class="esig-signer-right"> <a href="#" id="addRecipient_temp">'.__('+ Add Signer', 'esig-at') . '</a></span>
                    
               </div>
                                               ';
                                               
                        $more_option_page .=  apply_filters("esig-signer-order-filter-temp", "");
