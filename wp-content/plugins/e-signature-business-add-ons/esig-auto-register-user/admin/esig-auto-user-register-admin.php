        ...
        Cheers!', 'esig-aur');
            ...
            $esig_misc_more_content .='<div class="esig-settings-wrap">
                                    ...
                                    <div id="auto-register-signer"> 
                                             ...
                                             <h2>' . __('Auto Register Signer as WordPress User', 'esig-aur') . '</h2>
                                                                       ...
                                                                       ' . __(' Allow other document senders to enable the auto register feature:', 'esig-aur') . '<br>
 ...
 <div id="esig-auto-register-force-login1">';
             ...
             $esig_misc_more_content .=   '<a href="#" class="tooltip">
                   ...
                   <br>
					...
					<img src="' . ESIGN_ASSETS_DIR_URI . '/images/help.png" height="20px" width="20px" align="left">
					<span>
					' . __('This is the email that automatically gets sent to the signer/new user when their account is generated.', 'esig-aur') . '
					</span>
					</a>' . __('E-mail Template For User Register:', 'esig-aur') . '<br><br>';


            $subject = WP_E_Sig()->setting->get_generic('esig_misc_email_subject');
            if (empty($subject)) {
                $subject = __("New wordpress user has created", "esig-aur");
            }
        ...
        public function add_register_document_contents($advanced_more_options) {
            ...
            $advanced_more_options .='<p><a href="#" class="tooltip">
                                    <img src="' . ESIGN_ASSETS_DIR_URI . '/images/help.png" height="20px" width="20px" align="left"><span>' . __('Automatically register a signer as a WordPress user when they successfully sign this agreement.', 'esig-aur') . '</span>
                                    </a><input type="checkbox" id="esig_auto_add_register" name="esig_auto_add_register" value="1" ' . $esig_auto_add_register_checked . '>
                                    ' . __('Auto-register signer as a Wordpress User (when this document is successfully Signed)', 'esig-aur') . '</p>
		
							<div id="esig_auto_register_setting" style="display:' . $display . ';margin-left:75px;">
            ...
            $advanced_more_options .='</select>
								...
								<div><input type="checkbox" id="esig_auto_register_enable_email" name="esig_auto_register_enable_email" value="1" ' . $esig_auto_register_enable_email_checked . '><span style="margin-left:4px;">' . __("Disable the email that's sent to the user that contains login details", "esig-aur") . '</span></div><br>
								<div><input type="checkbox" id="esig_enable_admin_email" name="esig_enable_admin_email" value="1" ' . $esig_enable_admin_email_checked . '><span style="margin-left:4px;">' . __("Disable the new user registration email that's sent to the admin", "esig-aur") . '</span></div><br>
					</div>
