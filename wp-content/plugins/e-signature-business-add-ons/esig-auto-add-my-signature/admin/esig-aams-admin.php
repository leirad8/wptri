...
if (!class_exists('ESIG_AAMS_Admin')) :
    ...
    class ESIG_AAMS_Admin {
        ...
        public function show_aams_more_action($template_data) {
            ...
            $template_data['document_add_signature_txt'] = sprintf(__("Automatically add my (%s) signature to this document.", 'esig-aasm'), WP_E_Sig()->user->get_esig_admin_name(get_current_user_id()));
        ...
        public function record_view_shortcode($template_data, $args) {
            ...
            if ($document->add_signature) {
                $owner_data = array(
                    ...
                    'sign_date' => __("Signed On: ","esig") . $api->document->esig_date_format($document->last_modified),
                );
