...
Tags: formidable, honeypot, spam, captcha
...
Tested to work with both **Formidable** (free) and [Formidable Pro](http://www.wpbiz.co/go/forms) (best bet for awesome form power!)

**A note to Formidable Pro users:** You paid to receive extra features in the Formidable plugin. Me too, it's well worth it. This Honeypot plugin, and Ryan (the developer) are not connected to Formidable in any way. Since this adds another very helpful feature to Formidable, I ask you to send a [donation at WPbiz.co](http://wpbiz.co/donate/) to say thanks and encourage future developemnt.

== Installation ==

1. Upload and activate the plugin.
1. It will automatically add honeypot protection to all Formidable forms.
...
Yes, it adds a honeypot to all forms, regardless of whether you have the [Pro](http://www.wpbiz.co/go/forms) or Free versions of Formidable.

== Screenshots ==

1. Nothing to see here, but enough to trap robots.
