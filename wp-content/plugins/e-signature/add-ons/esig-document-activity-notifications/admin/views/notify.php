                          ...
                          <tr>
                            <td
                              ...
                              <h1 style="font-size:18px;margin:0 0 10px
                                0;font-weight:bold"><?php  printf( __( 'Document Viewed: %s','esig'),$data['document_title']);?>
                              </h1>
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p
                                ...
                                0px"><?php printf( __( 'Hi %s','esig'),$data['owner_first_name'])?>,<br>
                                <br>
                                <?php printf( __( "%s %s  has viewed the document.
							  We'll let you know if they sign it. ","esig"),$data['signer_name'],$data['signer_email']);?>
                                </p>
								<p
                                style="line-height:1.4em;font-size:14px;margin:10px
                                0px"><?php _e(" If you'd like more information, you can visit the documents page below.","esig") ;?> 
                                </p>
                              <hr
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <div style="margin:20px 0px 20px 0px">
                                ...
                                <?php
                                      ...
                                      ?>
                                <!--[if mso]>
  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo $data['view_url']; ?>" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="<?php echo  $background_color; ?>">
    <w:anchorlock/>
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p style="margin:10px 0px;font-size:14px;line-height:1.4em;color:#ff0000">
                              	<?php _e('Warning: Do not forward this email to others or
                                else they will have access to your document (on your behalf).','esig');?></p>
                            </td>
                          </tr>
                        </tbody>
                      </table>
