...
<div class='signatures row'>
	...
	";
                ...
                if (!empty($allinvitaions)) {
                    ...
                    foreach ($allinvitaions as $invite) {
                        ...
                        if (!$this->signature->userHasSignedDocument($invite->user_id, $doc_id)) {
                            ...
                            $sign_bottom_text .= __("(Awaiting Signature)", "esig-pdf");
                        } else {
                            $sign_bottom_text = sprintf(__("Signed By %s", "esig-pdf"), $fullname);
                            $sign_bottom_text .= "<br>" . __("Signed On:","esig") . $this->document->esig_date_format($date);
                        }
					...
					<div class="signature-top" style="width:255px;text-align:left;background-image:transparent url(' . $small_img . ');background-position: left bottom;">
                    ...
                    $html .='<div class="signature-left" align="left">
					<div class="signature-top" style="width:255px;text-align:left;background-image:transparent url(' . $small_img2 . ') left bottom;height:100px;">
                ...
                if ($document->add_signature) {
                    ...
                    $small_img1 = ESIGN_DIRECTORY_URI . "add-ons/esig-save-as-pdf/admin/assets/images/sign-here_blank_pdf.jpg";

                    $html .='<div class="signature-left" align="left">
					<div class="signature-top" style="width:255px;text-align:left;background:transparent url(' . $small_img1 . ') left bottom;height:100px;vertical-align:bottom;">
					
					' . $sign_admin . '
					
					</div><div class="signature-top">';
                    $html .= sprintf(__("Signed By %s %s", "esig-pdf"), $owner->first_name, $owner->last_name);
                    $html .= "<br>".__("Signed On","esig") .": " . $this->document->esig_date_format($document->last_modified) . "</div></div>";
                }
        ...
        public function document_add_pdf_option($template_data) {
            ...
            $html = sprintf(__('<p>
			<label>' . __('Save as PDF <span class="description">default settings:</span>', 'esig') . '</label>
