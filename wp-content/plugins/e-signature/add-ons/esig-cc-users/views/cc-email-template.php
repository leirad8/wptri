...
<?php                                                                                                      
  ...
  <p>    <?php  _e('The Document is being sent to the following signers:','esig'); ?></p>
            ...
            foreach($data->signers as $signers){
                 echo esigHtml($signers->signer_name) . " (" . $signers->signer_email . ")<br>" ; 
            } 
          ?>
        ...
        <!--[if mso]>
  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo $data->signed_link ;?>" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="<?php echo apply_filters('esig-invite-button-background-color', '#0083c5'); ?>">
    <w:anchorlock/>
