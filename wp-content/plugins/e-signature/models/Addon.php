...
class WP_E_Addon extends WP_E_Model {
    ...
    public function esig_addons_tabs($current = 'all') {
        ...
        $tabs = array('all' => __('All','esig'), 'enable' => __('Enabled','esig'), 'disable' => __('Disabled','esig'), 'get-more' => __('Get More','esig'));
    ...
    public function esig_get_addons_file_path($plugin_root_folder) {
        ...
        $installed_directory = Esig_Addons::get_installed_directory($plugin_root_folder);
