    ...
    if ($all_addons_list) {
        ...
        if ($license_key == "no") {
            ...
            <div class="esig-add-on-block esig-pro-pack open">
                ...
                <p style="display:block;"><?php _e("A valid WP E-Signature license is required for access to critical updates and support. Without a license you are putting you and your signers at risk. To protect yourself and your documents please update your license.","esig");?></p><a href="https://www.approveme.com/#pricingPlans" class="esig-btn-pro" target="_blank"><?php _e("Purchase a license","esig");?> </a>
            </div>
