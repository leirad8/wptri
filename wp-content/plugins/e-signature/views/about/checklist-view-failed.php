    ...
    <div class='head-check'>
      ...
      <div id ="error-show" class ="check-fail">
        ...
        <?php }
         ...
         <div class="failed-check" >See <a href="https://www.approveme.com/wp-digital-signature-plugin-docs/article/increase-memory-limit/" target="_blank"><?php _e("How to Increase the Memory Limit for details","esig");?></a></div>         
         <?php }
        ...
        <?php }
         if(!function_exists('mcrypt_create_iv')){   $is_esig_system_error = true; ?>
          <div class="checklist-failed"> <span class="icon-exit checklist-exit-icon"> </span><b><?php _e("PHP Mcrypt not supported","esig");?></b></div>
          <div class="failed-check" style="height: 62px;">See <a href="https://www.approveme.com/wp-digital-signature-plugin-docs/article/mcrypt-security/"><?php _e("Mcrypt Security for details","esig");?></a></div>
        <?php }
