...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p
                                ...
                                <?php
                                  ...
                                  $custom_message = apply_filters('esig_admin_confirmation_custom_message','',$document_checksum=$data['document_checksum']);
							...
							{
									 _e(' Audit Trail Serial#:','esig');?> <?php echo $data['document_id']; 
							 }
							 ?>
                                </p>
                              <hr
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <div style="margin:20px 0px 20px 0px">
                               ...
                               <!--[if mso]>
  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo $data['view_url']; ?>" style="height:40px;v-text-anchor:middle;width:250px;" arcsize="10%" stroke="f" fillcolor="<?php echo $data['background_color']; ?>">
    <w:anchorlock/>
