...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p
                                ...
                                <?php
                                  ...
                                  $custom_message = apply_filters('esig_signer_confirmation_custom_message','',$document_checksum=$data['document_checksum']);
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              ...
                              <!-- signed button start here -->
                               ...
                               <!--[if mso]>
  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo $data['view_url']; ?>" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="<?php echo $data['background_color']; ?>">
    <w:anchorlock/>
