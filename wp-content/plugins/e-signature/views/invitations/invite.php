...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p
                                ...
                                <?php _e('Please add your signature to the document below.', 'esig' );?>  - <a
                                    href="mailto:<?php echo $data['user_email']; ?>?subject=RE%3A%20%7B<?php echo urlencode($data['document_title']); ?>%7D"
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              ...
                              <?php
                                      ...
                                      ?>
                               <!--[if mso]>
  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo $data['invite_url']; ?>" style="height:50px;v-text-anchor:middle;width:150px;" arcsize="10%" stroke="f" fillcolor="<?php echo $background_color ;  ?>">
    <w:anchorlock/>
  ...
  <td align="center" width="150" height="50" bgcolor="<?php echo $background_color ;  ?>" style="color: #ffffff; display: block;">
    <a href="<?php echo $data['invite_url']; ?>" style="font-size:14px; font-weight: bold; font-family:sans-serif; text-decoration: none; line-height:50px; width:100%; display:inline-block">
...
Neue',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;border-collapse:collapse"
              ...
              <table style="margin-top:20px" border="0" cellpadding="20"
                ...
                <tbody>
                  <tr style="border-collapse:collapse">
                    <td style="width: 70% !important ;padding: 16px 12px 0px 20px;vertical-align: top;font-family: 'Helvetica Neue',Arial,Helvetica,sans-serif;font-size: 12px;line-height: 1.5em;border-collapse: collapse;color: #555;"
                      align="left"><?php echo sprintf( __( 'This message was sent to you by %s. If you would rather not receive email from this sender you may contact the sender with your request.', 'esig'), $data['user_full_name'] );?> </td>
                    <td style="width:10%;padding:0px 12px 0px
...
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
                    ...
                    <td style="width:15% !important;padding:0px 0px 0px
                      0px;vertical-align:top;font-family:'Helvetica
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
align="center"> <a href="<?= WP_E_Email::get_site_url(); ?>" target="_blank"><img 
src="<?php echo $data['assets_dir']; ?>/images/verified-email.jpg" style="width: 175px;margin-top: -8px;" class="emailClass"
                              alt="WP E-Signature" border="0" 
