...
$regex_is_user_agent_bot = 'MSIE 6|bot|facebook|crawler|indexer|feed|flipboard|slurp|re[ea]der|spider|scoutjet|ssowl|baidu|google|news|pubsub|^expo9|^tzogeoagent|jakarta|teoma|scrap(?:[ey]|ing)|siteimprove|nutch|coccoc|wazzup|genieo|thunderstone|Rackspace Monitoring|abonti|wpe-content-performance|bingpreview|SimplePie|yandex|duckduckgo|WordPress/[0-9]+\.[0-9]+';
